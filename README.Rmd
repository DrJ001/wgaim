...
[![packageversion](https://img.shields.io/badge/Package%20version-`r gsub('-', '--', version)`-orange.svg?style=flat-square)](https://github.com/DrJ001/wgaim/commits/master)
[![Last-changedate](https://img.shields.io/badge/last%20change-`r gsub('-', '--', Sys.Date())`-yellowgreen.svg)](https://github.com/DrJ001/wgaim/commits/master)
...
For a quick but complete introduction of the functionality of the package please visit the [vignette](https://cran.r-project.org/package=wgaim/vignettes/wgaim_intro.html) on the CRAN package page.
